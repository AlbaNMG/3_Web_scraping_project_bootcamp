...
def frame3():
    ...
    #score widget
    score = QLabel("100")
    score.setStyleSheet("font-size: 100px; color: #339CFF; margin: 0 75px 0px 75px;")
    widgets["score"].append(score)

    #go back to work widget
    message2 = QLabel("“Anyone who stops learning is old,\n whether at twenty or eighty. — Henry Ford.”")
    ...
    button.setStyleSheet(
        "*{background:'#339CFF'; padding:25px 0px; border: 1px solid '#339CFF'; color: 'white'; font-family: 'Arial'; font-size: 25px; border-radius: 40px; margin: 10px 300px;} *:hover{background:'#339CFF';}"
        )
    button.setCursor(QCursor(QtCore.Qt.PointingHandCursor))
...
def frame4():
    #sorry widget
    message = QLabel("Sorry, that answer \n was wrong!\n L.coins earned today:")
    message.setAlignment(QtCore.Qt.AlignRight)
    message.setStyleSheet(
